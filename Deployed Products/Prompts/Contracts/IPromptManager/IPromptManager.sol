...
/**
 * @title IPromptManager
 * @dev This contract interface provides the functionality for managing the prompt deployment process.
 */
interface IPromptManager {
    ...
    /**
     * @notice Checks if the PromptManager is paused.
